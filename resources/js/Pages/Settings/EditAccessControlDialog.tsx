...
const EditAccessControlDialog = ({control} : {control: AccessControl}) => {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        router.put(route('settings.updateAccessControl', control.id), { ...data },
                {
                onSuccess: () => {
                    toast({ title: 'Success', description: 'Access Control updated successfully' });
                    setIsOpen(false);
                    setData('password', '');
                },
                onError: () => {
                    toast({ title: 'Error', description: 'Failed to update Access Control', variant: 'destructive' });
                },
            });
