                            ...
                            <CardContent className='grid grid-cols-3'>
                                <div className='space-y-4 lg:col-span-2'>
                                    <div className="flex flex-wrap gap-4">
                                        <img src={application.photo} className='size-24 rounded object-cover bg-muted' />
                                        <div>
                                            ...
                                            <div className='space-x-2'>
                                                <span>Phone:</span>
                                                <strong className='text-muted-foreground'>{application.phone}</strong>
                                            </div>
                                            <div className='space-x-2'>
                                                <span>Address:</span>
                                                <strong className='text-muted-foreground'>{application.address}</strong>
                                            </div>
                                        </div>
                                    </div>
                                    <div className='grid grid-cols-2'>
                                        <div>
                                            <div className='space-x-2'>
                                                ...
                                                <strong className='text-muted-foreground capitalize'>{application.occupation}</strong>
                                            </div>
                                            <div className='space-x-2'>
                                                <span>Gender:</span>
                                                <strong className='text-muted-foreground capitalize'>{application.gender}</strong>
                                            </div>
                                            <div className='space-x-2'>
                                                <span>Marital Status:</span>
                                                <strong className='text-muted-foreground capitalize'>{application.marital_status}</strong>
                                            </div>
                                        </div>
                                        <div>
                                            <div className='space-x-2'>
                                                <span>Date of Birth:</span>
                                                <strong className='text-muted-foreground capitalize'>{application.date_of_birth}</strong>
                                            </div>
                                            <div className='space-x-2'>
                                                <span>Preferred Time:</span>
                                                <strong className='text-muted-foreground capitalize'>{application.preferred_time}</strong>
                                            </div>
                                        </div>
                                        <div></div>
                                    </div>
                                ...
                                <Card className='bg-muted'>
                                    ...
                                    <CardContent className='overflow-hidden'>
                                        <div>
                                            <div className='space-x-2'>
                                                <span>Name:</span>
                                                <strong className='capitalize'>{application.emergency_person_name}</strong>
                                            </div>
                                            <div className='space-x-2'>
                                                <span>Phone:</span>
                                                <strong className='text-muted-foreground'>{application.emergency_person_phone}</strong>
                                            </div>
                                        </div>
                                    </CardContent>
                                </Card>
